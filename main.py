...
async def evo_cycle_spam(uids, key, iv, region):
    ...
    while evo_cycle_running:
        ...
        for emote_number, emote_id in evo_emotes.items():
            ...
            # Wait 7 seconds before moving to next emote (as requested)
            if evo_cycle_running:
                print(f"Waiting 7 seconds before next emote...")
                for i in range(7):
                    if not evo_cycle_running:
                        break
                    await asyncio.sleep(1)
...
async def EncRypTMajoRLoGin(open_id, access_token):
    ...
    major_login.client_version = "2.121.2"
...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]MX NIROB     
[FFD700]✨ Name on instagram : [FFFFFF] BLACK_APISCODEX076❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> MX NIROB  ❄️  ⚡
"""
                            ...
                            if len(parts) < 3:
                                ...
                                try:
                                    ...
                                    await safe_send_message(response.Data.chat_type, error_msg, uid, chat_id, key, iv)                                                                                                                                                                                                               
                                                                                          ...
                                                                                          # FIXED JOIN COMMAND
                        if inPuTMsG.startswith('n'):
                            # Process n command in any chat type
                            parts = inPuTMsG.strip().split()
                            if len(parts) < 2:
                                error_msg = f"[B][C][FF0000]❌ ERROR! Usage: n (team_code)\nExample: n ABC123\n"
                                await safe_send_message(response.Data.chat_type, error_msg, uid, chat_id, key, iv)
                            else:
                                CodE = parts[1]
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To NIROB bot"
                            ...
                            group_commands = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[FFFF00]╔═══════╗
[C][B][FF7244]│[FE4250]▶[C81F9C]֯│[FFFF00]║[FFFFFF] advance comand [FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[FFFF00]╚═══════╝
...
[00FFFF]━━━━━━━━━━━━[FF69B4]"""
                            ...
                            # ───── Advanced Commands ─────
                            advanced_commands = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[00FFFF]╔═══════╗
[C][B][FF7244]│[FE4250]ⓕ[C81F9C]֯│[FFFF00]║[FFFFFF] All Spam command[FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[00FFFF]╚═══════╝
├─ [00BFFF]Spam Invites (30x)
│  └─ [BA55D3]/spm_inv [uid]
├─ [00BFFF]Stop Spam Invites
│  └─ [BA55D3]/stop spm_inv
├─ [00BFFF]Ghost Join Team
│  └─ [BA55D3]/ghost [code]
├─ [00BFFF]Lag Attack Team
│  └─ [BA55D3]/lag [code]
├─ [00BFFF]Stop Lag Attack
│  └─ [BA55D3]/stop lag
└─ [00BFFF]Reject Spam
   └─ [BA55D3]/reject [uid]
[00BFFF]━━━━━━━━━━━━[BA55D3]"""
                            ...
                            emote_commands = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[FFFF00]╔═══════╗
[C][B][FF7244]│[FE4250]◯[C81F9C]֯│[FFFF00]║[FFFFFF] X Emot comand [FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[FFFF00]╚═══════╝
├─ [FFFFFF]Send Single Emote
│  └─ [32CD32]/e [uid] [id]
├─ [FFFFFF]Fast Emote (25x)
│  └─ [32CD32]/fast [uid] [id]
└─ [FFFFFF]Custom Emote (X times)
   └─ [32CD32]/p [uid] [id] [x]
[7CFC00]━━━━━━━━━━━━[32CD32]"""
                            ...
                            evo_commands = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[FFFF00]╔═══════╗
[C][B][FF7244]│[FE4250]▶[C81F9C]֯│[FFFF00]║[FFFFFF] Emot comand [FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[FFFF00]╚═══════╝
├─ [00BFFF]Send Evolution Emote
│  └─ [FFFF00]/evo [uid] [1-21]
├─ [00BFFF]Fast Evo (25x)
│  └─ [FFFF00]/evo_fast [uid] [1-21]
├─ [00BFFF]Custom Evo (X times)
│  └─ [FFFF00]/evo_c [uid] [1-21] [x]
├─ [00BFFF]Auto Cycle All Evo
│  └─ [FFFF00]@ [uid]
└─ [00BFFF]Stop Evo Emote Cycle
   └─ [FFFF00]/s
[00BFFF]━━━━━━━━━━━━[FFA500]"""
...
[C][B][FF7244]│[FE4250]ⓕ[C81F9C]֯│[FFFF00]║[FFFFFF] All Ai command [FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[00BFFF]╚═══════╝
├─ [00BFFF]Get player bio by uid
│  └─ [FFFFFF]/bio [uid]
├─ [00BFFF]Fetch Instagram User Info
│  └─ [FFFFFF]/ig [username]
├─ [00BFFF]Send custom spam
│  └─ [FFFFFF]/ms <text>
├─ [00BFFF]Ask AI Anything
│  └─ [FFFFFF]/ai [question]
├─ [00BFFF]Admin Information
│  └─ [FFFFFF]/admin
└─ [00BFFF]Bot Status Check
   └─ [FFFFFF]/status
   [00BFFF]━━━━━━━━━━━━[1E90FF]"""
                            ...
                            badge_commands = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[FFFF00]╔═══════╗
[C][B][FF7244]│[FE4250]◯[C81F9C]֯│[FFFF00]║[FFFFFF] v bags spam [FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[FFFF00]╚═══════╝
├─ [00BFFF]Join Req Craftland Badge
│  └─ [FF4500]/s1 [uid]
├─ [00BFFF]Join Req New V-Badge
│  └─ [FF4500]/s2 [uid]
├─ [00BFFF]Join Req Moderator Badge
│  └─ [FF4500]/s3 [uid]
├─ [00BFFF]Quick Spam 
│  └─ [FF4500]/q [c+id+e]
├─ [00BFFF]Room request spam
│  └─ [FF4500]/room [uid] [room]
└─ [00BFFF]Join Requests All Badge
   └─ [FF4500]/spam [uid]
[00BFFF]━━━━━━━━━━━━[FF4500]"""
                            ...
                            footer ="""[00FFFA]╔══════════════════╗
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[FFFF00]╔═══════╗
[C][B][FF7244]│[FE4250]◯[C81F9C]֯│[FFFF00]║[FFFFFF] x_NIROB240[FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[FFFF00]╚═══════╝
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[00BFFF]╔═══════╗
[C][B][FF7244]│[FE4250]ⓕ[C81F9C]֯│[FFFF00]║[FFFFFF]FF NIROB VIP [FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[00BFFF]╚═══════╝
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[FF69B4]╔═══════╗
[C][B][FF7244]│[FE4250]▶[C81F9C]֯│[FFFF00]║[FFFFFF] NIROB Codex[FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[FF69B4]╚═══════╝
[00FFFA]╚═════════════════╝"""
...
async def MaiiiinE():
    Uid , Pw = '4178193545','DB0138602972CFD8C89DEABD816CE0CE84F9EA604EC96F2E6AB3E43A39B86710'
    ...
    os.system('clear')
    print(render('BLACK_APISs', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 BLACK_APIS BOT - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using BLACK_APIS")
    sys.exit(0)
